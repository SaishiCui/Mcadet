...
ggplot(histdf, aes(x=log_mean_expression, fill = Method))+geom_density()+facet_wrap(~Method)+theme_bw()+
  labs(x = "log mean expression", y = "Density", 
       title = "PBMC coarse datasets" ) +  
  theme(
  ...
  geom_vline(data = histmeandf, aes(xintercept = xintercept), linetype ="dashed", color = "blue", linewidth = 0.8)
...
for (i in 1:24) {
    ...
    load(file =paste0("C:/Users/css22/Desktop/Thesis/SPARSim/SparSim_Mcadet_data/SparSim_", i, ".RData"))
...
ggplot(histdf, aes(x=log_mean_expression, fill = Method))+geom_density()+facet_wrap(~Method)+theme_bw()+
  labs(x = "log mean expression", y = "Density", 
       title = "Simulation coarse datasets" ) +  
  theme(
    legend.position="None",
    plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
    strip.text= element_text(size=10, face="bold"),
...
for (i in 1:24) {
  ...
  load(file =paste0("C:/Users/css22/Desktop/Thesis/SPARSim/SparSim_Mcadet_data/SparSim_fine_", i, ".RData"))
...
ggplot(histdf, aes(x=log_mean_expression, fill = Method))+geom_density()+facet_wrap(~Method)+theme_bw()+
  labs(x = "log mean expression", y = "Density", 
       title = "Simulation fine datasets" ) +  
  theme(
    legend.position="None",
    plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
    strip.text= element_text(size=10, face="bold"),
