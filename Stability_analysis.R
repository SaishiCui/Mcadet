...
for (i in 1:8) {
  for (j in 1:3) {
    ...
    assign(paste0("Mcadet_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
           result1)
    
    assign(paste0("Mcadet_PBMC_fine_stable2_",donor.set[i], "_", time.set[j]),
           result2)
    ...
    assign(paste0("BreFS_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]), result_Bre1$Gene)
    assign(paste0("BreFS_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]), result_Bre2$Gene)
    ...
    assign(paste0("M3Drop_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j]), result_M3Drop1$Gene)
    assign(paste0("M3Drop_PBMC_fine_stable2_",
    ...
    assign(paste0("NBDrop_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j]), result_NBDrop1$Gene)
    assign(paste0("NBDrop_PBMC_fine_stable2_",
    ...
    assign(paste0("random_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j]), result_random1)
    assign(paste0("random_PBMC_fine_stable2_",
    ...
    assign(paste0("scryFS_PBMC_fine_stable1_", 
                  donor.set[i], "_", time.set[j]), result_scry1)
    assign(paste0("scryFS_PBMC_fine_stable2_", 
    ...
    assign(paste0("SeuratDisp_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]), result_SeuratDisp1)
    assign(paste0("SeuratDisp_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]), result_SeuratDisp2)
    assign(paste0("SeuratMvp_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]), result_SeuratMvp1)
    assign(paste0("SeuratMvp_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]), result_SeuratMvp2)
    assign(paste0("SeuratVst_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]), result_SeuratVst1)    
    assign(paste0("SeuratVst_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]), result_SeuratVst2)    
    
    
    

    save(list = paste0("Mcadet_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/Mcadet_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("Mcadet_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/Mcadet_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    
    
    save(list = paste0("BreFS_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/BreFS_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("BreFS_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/BreFS_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    save(list = paste0("M3Drop_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/M3Drop_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("M3Drop_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/M3Drop_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    save(list = paste0("NBDrop_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/NBDrop_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("NBDrop_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/NBDrop_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    save(list = paste0("random_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/random_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("random_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/random_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    
    save(list = paste0("scryFS_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/scryFS_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("scryFS_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/scryFS_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    save(list = paste0("SeuratDisp_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratDisp_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("SeuratDisp_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratDisp_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    
    save(list = paste0("SeuratMvp_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratMvp_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("SeuratMvp_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratMvp_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    
    
    save(list = paste0("SeuratVst_PBMC_fine_stable1_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratVst_PBMC_fine_stable1_",
                  donor.set[i], "_", time.set[j], ".RData"))
    
    save(list = paste0("SeuratVst_PBMC_fine_stable2_", donor.set[i], "_", time.set[j]),
         file = 
           paste0("C:/Users/13541/Desktop/Thesis/Results/stability_results/SeuratVst_PBMC_fine_stable2_",
                  donor.set[i], "_", time.set[j], ".RData"))
...
stability_output <- function(data, resolution){
Jaccard = c()
Method  = c()
group = c()
  ...
  group = append(group, "Between Split 2 and HVGs")
    ...
    for (i in 1:8) {
      ...
      mcadet1 <- get(paste0("Mcadet_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))$gene
      mcadet2 <- get(paste0("Mcadet_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))$gene
      mcadet_jac = jaccard(mcadet1, mcadet2)
      Jaccard = append(Jaccard, mcadet_jac)
      Method = append(Method, "Mcadet")
      group = append(group, "Between split datasets")
      ...
      vst1 <- get(paste0("SeuratVst_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      vst2 <- get(paste0("SeuratVst_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      vst_jac = jaccard(vst1, vst2)
      Jaccard = append(Jaccard, vst_jac)
      Method = append(Method, "Seurat Vst")
      group = append(group, "Between split datasets")
      ...
      disp1 <- get(paste0("SeuratDisp_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      disp2 <- get(paste0("SeuratDisp_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      disp_jac = jaccard(disp1, disp2)
      Jaccard = append(Jaccard, disp_jac)
      Method = append(Method, "Seurat Disp")
      group = append(group, "Between split datasets")
      ...
      mvp1 <- get(paste0("SeuratMvp_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      mvp2 <- get(paste0("SeuratMvp_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      mvp_jac = jaccard(mvp1, mvp2)
      Jaccard = append(Jaccard, mvp_jac)
      Method = append(Method, "Seurat Mvp")
      group = append(group, "Between split datasets")
      ...
      NBdrop1 <- get(paste0("NBDrop_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      NBdrop2 <- get(paste0("NBDrop_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      NBdrop_jac = jaccard(NBdrop1, NBdrop2)
      Jaccard = append(Jaccard, NBdrop_jac)
      Method = append(Method, "NBDrop")
      group = append(group, "Between split datasets")
      ...
      M3Drop1 <- get(paste0("M3Drop_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      M3Drop2 <- get(paste0("M3Drop_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      M3Drop_jac = jaccard(M3Drop1, M3Drop2)
      Jaccard = append(Jaccard, M3Drop_jac)
      Method = append(Method, "M3Drop")
      group = append(group, "Between split datasets")
      ...
      Brennecke1 <- get(paste0("BreFS_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      Brennecke2 <- get(paste0("BreFS_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      Brennecke_jac = jaccard(Brennecke1, Brennecke2)
      Jaccard = append(Jaccard, Brennecke_jac)
      Method = append(Method, "Brennecke")
      group = append(group, "Between split datasets")
      ...
      scry1 <- get(paste0("scryFS_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      scry2 <- get(paste0("scryFS_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      scry_jac = jaccard(scry1, scry2)
      Jaccard = append(Jaccard, scry_jac)
      Method = append(Method, "Scry")
      group = append(group, "Between split datasets")
      ...
      random1 <- get(paste0("random_PBMC_" , resolution , "_stable1_", donor.set[i], "_", time.set[j]))
      random2 <- get(paste0("random_PBMC_" , resolution , "_stable2_", donor.set[i], "_", time.set[j]))
      random_jac = jaccard(random1, random2)
      Jaccard = append(Jaccard, random_jac)
      Method = append(Method, "Random")
      group = append(group, "Between split datasets")
 ...
 Jaccard[group == "Between split datasets"] = scale(Jaccard[group == "Between split datasets"])
 Jaccard[group == "Between Split 1 and HVGs"] = scale(Jaccard[group == "Between Split 1 and HVGs"])
 Jaccard[group == "Between Split 2 and HVGs"] = scale(Jaccard[group == "Between Split 2 and HVGs"])
...
stability_SparSim_coarse_df <- stability_output("SparSim", "coarse")
stability_SparSim_fine_df <- stability_output("SparSim", "fine")
stability_PBMC_coarse_df <- stability_output("PBMC", "coarse")
stability_PBMC_fine_df <- stability_output("PBMC", "fine")
...
generate_figure_barplot <- function(DF, plot_title, show_legend){
  ...
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Mcadet" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Mcadet" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "NBDrop" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "NBDrop" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "M3Drop" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "M3Drop" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Brennecke" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Brennecke" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Scry" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Scry" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Seurat Disp" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Seurat Disp" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Seurat Mvp" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Seurat Mvp" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Seurat Vst" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Seurat Vst" & DF$group == "Between split datasets"]))
  mean_jaccard = append(mean_jaccard, mean(DF$Jaccard[DF$Method == "Random" & DF$group == "Between split datasets"]))
  sd_jaccard = append(sd_jaccard, sd(DF$Jaccard[DF$Method == "Random" & DF$group == "Between split datasets"]))
