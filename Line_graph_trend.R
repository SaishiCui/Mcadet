...
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_SparSim_coarse_df_clustering.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_SparSim_fine_df_clustering.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_PBMC_coarse_df_clustering.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_PBMC_fine_df_clustering.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_SparSim_coarse_df_Jac.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_SparSim_fine_df_Jac.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_PBMC_coarse_df_Jac.RData")
load(file ="C:/Users/13541/Desktop/Thesis/Results/Line_graph_trend/linegraph_PBMC_fine_df_Jac.RData")
...
generate_linegraph_figure <- function(DF, evatype,
                                      plot_title, y_title, show_legend){
  
  DF$method_vec = factor(DF$method_vec, levels = c("Mcadet", "scryFS",
                                                   "SeuratDisp", "SeuratVst",
                                                   "M3Drop", "NBDrop", "random"))
  if(show_legend){ 
    out_figure = ggplot(data =  DF, 
                        mapping = aes(x = number_vec, y = mean_vec, 
                                      colour = method_vec)) + geom_line(linewidth = 0.7)+
      geom_point()+
      ...
      theme( panel.grid = element_blank(),  
             ...
             axis.text.y = element_text(face = "bold", size = 12))}else{
                        ...
                        axis.text.y = element_text(face = "bold", size = 12))}else{
                          ...
                          out_figure = ggplot(data =  DF, 
                            ...
                            labs(x = "", y = y_title, 
                                 title = plot_title )+
                            theme_bw() + 
                            scale_x_continuous(limits=c(200, 3000), breaks=seq(300, 3000, 300))+
                            theme( panel.grid = element_blank(),  
                                   axis.title = element_text(face ="bold", size = 16),
                                   plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
                                   legend.position = "none",
...
a=data.frame("mean_vec" = linegraph_PBMC_fine_df_clustering[,5],
"number_vec" = linegraph_PBMC_fine_df_clustering[,6],
"method_vec" = linegraph_PBMC_fine_df_clustering[,7])



generate_linegraph_figure(linegraph_PBMC_fine_df_Jac, "Jaccard",
"PBMC fine datasets",  "Mean Jaccard Similarity", FALSE)+
  geom_vline(aes(xintercept = 1800), colour = "#990000", linetype = "dashed", linewidth = 0.7)
