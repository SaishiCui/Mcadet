...
standard.row.coord[which(pbmccell1_1_0 == "B"), 1:10]
B_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "B"), 1:10], 2, mean)
CD4_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "CD4 T"), 1:10], 2, mean)
CD8_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "CD8 T"), 1:10], 2, mean)
NK_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "NK"), 1:10], 2, mean)
Mono_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "Mono"), 1:10], 2, mean)
DC_centroid <- apply(standard.row.coord[which(pbmccell1_1_0 == "DC"), 1:10], 2, mean)
...
dist_df <- data.frame(cell_type = rep(c("B", "CD4 T", "CD8 T", "NK", "Mono", "DC"), 6),
           ...
           dis = c(sqrt(sum((principal.col.coord[B_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[B_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[B_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[B_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[B_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[B_label, 1:10] - DC_centroid)^2)),
                   
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD4T_label, 1:10] - DC_centroid)^2)),
                   
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[CD8T_label, 1:10] - DC_centroid)^2)),
                   
                   
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[NK_label, 1:10] - DC_centroid)^2)),
                   
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[Mono_label, 1:10] - DC_centroid)^2)),
                   
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - B_centroid)^2)),
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - CD4_centroid)^2)),
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - CD8_centroid)^2)),
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - NK_centroid)^2)),
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - Mono_centroid)^2)),
                   sqrt(sum((principal.col.coord[DC_label, 1:10] - DC_centroid)^2)))
           )
...
ggplot(dist_df, aes(x = cell_type, y = dis)) +
  ...
  scale_y_continuous(name = "Euclidean Distance (top 10 PCs)")
