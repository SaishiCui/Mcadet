...
load(file = "C:/Users/css22/Desktop/Thesis/Results/Time/time_df_cell.RData")
load(file = "C:/Users/css22/Desktop/Thesis/Results/Time/time_df_gene.RData")



library(ggplot2)
ggplot(time_df_cell, aes(x = Ncells, y = time, color = Method )) +
  geom_line(linewidth = 1) +
  geom_point(size = 1.5)+scale_x_continuous(n.breaks=10)+scale_y_continuous(n.breaks=10)+ 
  labs(x = "Number of Cells", y = "Time (mins)", title = "Running time of Mcadet by number of cells" )+
...
ggplot(time_df_gene, aes(x = Ngenes, y = time, color = Method)) +
  geom_line(linewidth = 0.8) +
  geom_point(size = 1.5)+scale_x_continuous(n.breaks=10)+scale_y_continuous(n.breaks=10)+ 
  labs(x = "Number of genes", y = "Time (mins)", title = "Running time of Mcadet by number of genes" )+
  theme( 
...
ggplot(time_df_cell, aes(x = Ncells, y = time, color = Method)) +
  geom_line(linewidth = 0.8) +
  geom_point(size = 1.5)+scale_x_continuous(n.breaks=10)+scale_y_continuous(n.breaks=10)+ 
  labs(x = "Number of cells", y = "Time (mins)", title = "Running time of Mcadet by number of genes" )+
  theme( 
