...
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_allgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_Randomgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_BreFSgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_M3Dropgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_NBDropgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_scryFSgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_SeuratDispgenes)
t.test(total_pseudo_cor_vector_Mcadetgenes, total_pseudo_cor_vector_SeuratMvpgenes)
